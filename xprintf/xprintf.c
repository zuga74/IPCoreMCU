...
static char *outptr;
static unsigned int num;    // size buff for sprintf
static unsigned int count;  // count byte write to buff

extern void ConPrintSemTake(void);
extern void ConPrintSemGive(void);
...
void xprintf_os (		/* Put a formatted string to the default device */
	const char*	fmt,	/* Pointer to the format string */
	...			/* Optional arguments */
)
{
...
unsigned short xsnprintf (		/* Put a formatted string to the memory */
	char* buff,			/* Pointer to the output buffer */
...
unsigned short xvsnprintf (		/* Put a formatted string to the memory */
	char* buff,			/* Pointer to the output buffer */
    unsigned int buff_size,   /* buff - size */
	const char*	fmt,	/* Pointer to the format string */
